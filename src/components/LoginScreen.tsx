...
export const LoginScreen: React.FC<LoginScreenProps> = ({ onLogin }) => {
  ...
  return (
    <div className="relative min-h-screen bg-[#0D1527] text-white flex items-center justify-center p-4 overflow-hidden font-sans selection:bg-rose-600 selection:text-white select-none">
      ...
      <div className="relative z-10 w-full max-w-md bg-slate-900/60 backdrop-blur-xl border border-slate-700/50 rounded-3xl p-8 shadow-2xl shadow-rose-950/40 space-y-6">
        {/* Brand Header */}
          ...
          <div>
            ...
            <div className="relative">
              <input
                type="text"
                readOnly
                value={selectedRole === 'analyst' ? 'analyst.bankops@sbi.co.in' : 'investigator.cyber@wbpolice.gov.in'}
        ...
        <div className="space-y-3 pt-2">
          <button
            ...
            className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-rose-600 to-rose-700 hover:from-rose-500 hover:to-rose-600 text-white font-extrabold py-3.5 rounded-xl text-xs shadow-xl shadow-rose-950/60 transition-all hover:scale-[1.02]"
          >
            <span>Login as {selectedRole === 'analyst' ? 'Bank Analyst' : 'Police Admin'}</span>
